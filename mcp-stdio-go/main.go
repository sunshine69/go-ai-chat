...
func main() {
	...
	s.AddTool(fetchUrlTool, fetchUrl)
	...
	s.AddTool(listDirTool, listDirectory)
	...
	createFileTool := mcp.NewTool("create_new_file",
	...
	s.AddTool(createFileTool, createNewFile)

	runCmdTool := mcp.NewTool("run_terminal_command",
	...
	s.AddTool(runCmdTool, runTerminalCommand)

	globSearchTool := mcp.NewTool("file_glob_search",
	...
	s.AddTool(globSearchTool, fileGlobSearch)

	findReplaceTool := mcp.NewTool("find_replace_in_file",
	...
	s.AddTool(findReplaceTool, findReplaceInFile)
